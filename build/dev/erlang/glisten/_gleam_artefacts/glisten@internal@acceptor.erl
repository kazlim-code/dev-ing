...
-type pool(MVY, MVZ) :: {pool,
        fun((MVY, glisten@internal@handler:loop_message(MVZ), glisten@internal@handler:connection(MVZ)) -> glisten@internal@handler:next(MVY, glisten@internal@handler:loop_message(MVZ))),
        integer(),
        fun((glisten@internal@handler:connection(MVZ)) -> {MVY,
            gleam@option:option(gleam@erlang@process:selector(MVZ))}),
        gleam@option:option(fun((MVY) -> nil)),
        glisten@transport:transport()}.
