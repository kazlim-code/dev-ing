...
?DOC(false).
-spec add_date_header(gleam@http@response:response(WUM)) -> gleam@http@response:response(WUM).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(WUP)) -> gleam@http@response:response(WUP).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(WUS)) -> gleam@http@response:response(WUS).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(WUV)) -> gleam@http@response:response(WUV).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(WVA)) -> gleam@http@response:response(WVA)).
