...
-type repeater(ABIG) :: any() | {gleam_phantom, ABIG}.
...
-spec call(integer(), ABIH, fun((ABIH, integer()) -> ABIH)) -> repeater(ABIH).
...
-spec set_function(repeater(ABIL), fun((ABIL, integer()) -> ABIL)) -> nil.
...
-spec update_state(repeater(ABIP), fun((ABIP) -> ABIP)) -> nil.
...
-spec set_state(repeater(ABIN), ABIN) -> nil.
