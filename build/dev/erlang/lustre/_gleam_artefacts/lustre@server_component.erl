...
-spec element(
    list(lustre@vdom@vattr:attribute(WKS)),
    list(lustre@vdom@vnode:element(WKS))
) -> lustre@vdom@vnode:element(WKS).
...
-spec include(lustre@vdom@vattr:attribute(WLE), list(binary())) -> lustre@vdom@vattr:attribute(WLE).
...
-spec subject(lustre:runtime(WLI)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(WLI)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(WLQ))
) -> lustre@runtime@server@runtime:message(WLQ).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(WLU))
) -> lustre@runtime@server@runtime:message(WLU).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(WLY)) -> nil)
) -> lustre@runtime@server@runtime:message(WLY).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(WMB)) -> nil)
) -> lustre@runtime@server@runtime:message(WMB).
...
-spec select(
    fun((fun((WMG) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(WMG))
) -> lustre@effect:effect(WMG).
select(Sel) ->
