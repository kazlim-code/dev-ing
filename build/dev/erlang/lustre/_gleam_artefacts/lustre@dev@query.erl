...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(UME)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(UME), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    ...
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(ULZ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(UNM)),
    selector()
) -> list(lustre@vdom@vnode:element(UNM)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(UNI), selector()) -> list(lustre@vdom@vnode:element(UNI)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(UND)), 'query'()) -> list(lustre@vdom@vnode:element(UND)).
...
-spec find_all(lustre@vdom@vnode:element(UMV), 'query'()) -> list(lustre@vdom@vnode:element(UMV)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(UMZ), 'query'()) -> list(lustre@vdom@vnode:element(UMZ)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(UNR), selector()) -> list(lustre@vdom@vnode:element(UNR)).
...
-spec find_in_list(
    ...
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(ULT), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(ULJ),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(ULJ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(ULO),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(ULO), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(ULE), 'query'()) -> {ok,
        lustre@vdom@vnode:element(ULE)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(UMP)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(UMP), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(UMK),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(UMK), lustre@vdom@path:path()}} |
    {error, nil}.
