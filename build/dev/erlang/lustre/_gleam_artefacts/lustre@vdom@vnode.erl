...
-type element(PRY) :: {fragment,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
        list(element(PRY)),
        lustre@internals@mutable_map:mutable_map(binary(), element(PRY))} |
    {element,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
...
?DOC(false).
-spec to_keyed(binary(), element(PSV)) -> element(PSV).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    ...
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    list(element(PRZ)),
    lustre@internals@mutable_map:mutable_map(binary(), element(PRZ))
) -> element(PRZ).
...
-spec element(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(PSG)),
    list(element(PSG)),
    lustre@internals@mutable_map:mutable_map(binary(), element(PSG)),
    boolean(),
    boolean()
) -> element(PSG).
element(
...
-spec element_to_json(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(PSY)),
    list(element(PSY))
) -> gleam@json:json().
