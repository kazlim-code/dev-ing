...
-type diff(SEV) :: {diff,
        lustre@vdom@patch:patch(SEV),
        lustre@vdom@events:events(SEV)}.

-type attribute_change(SEW) :: {attribute_change,
        list(lustre@vdom@vattr:attribute(SEW)),
        list(lustre@vdom@vattr:attribute(SEW)),
        lustre@vdom@events:events(SEW)}.
...
-spec diff_attributes(
    ...
    lustre@vdom@events:events(SFY),
    list(lustre@vdom@vattr:attribute(SFY)),
    list(lustre@vdom@vattr:attribute(SFY)),
    list(lustre@vdom@vattr:attribute(SFY)),
    list(lustre@vdom@vattr:attribute(SFY))
) -> attribute_change(SFY).
...
?DOC(false).
-spec do_diff(
    list(lustre@vdom@vnode:element(SFC)),
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(SFC)),
    list(lustre@vdom@vnode:element(SFC)),
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(SFC)),
    ...
    integer(),
    lustre@vdom@path:path(),
    list(lustre@vdom@patch:change(SFC)),
    list(lustre@vdom@patch:patch(SFC)),
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    lustre@vdom@events:events(SFC)
) -> diff(SFC).
do_diff(
    Old,
    Old_keyed,
