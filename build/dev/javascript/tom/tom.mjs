  ...
  while (true) {
    ...
    if (input instanceof $Empty) {
      ...
      if ($ === "0" && ms < 100_000) {
        ...
        loop$ms = ms * 10 + 0;
      } else if ($ === "1" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 1;
      } else if ($ === "2" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 2;
      } else if ($ === "3" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 3;
      } else if ($ === "4" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 4;
      } else if ($ === "5" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 5;
      } else if ($ === "6" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 6;
      } else if ($ === "7" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 7;
      } else if ($ === "8" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 8;
      } else if ($ === "9" && ms < 100_000) {
        let input$1 = input.tail;
        loop$input = input$1;
        loop$seconds = seconds;
        loop$ms = ms * 10 + 9;
