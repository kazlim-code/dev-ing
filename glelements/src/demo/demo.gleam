...
fn card_section() -> Element(a) {
  html.section([attribute.class("grid gap-4 p-4 border border-neutral-200 dark:border-neutral-800 rounded bg-neutral-100 dark:bg-neutral-900 dark:text-white")], [
    html.h2([attribute.class("text-xl")], [text("Cards")]),
    html.div(
    [attribute.class("grid gap-4")],
    [
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("card_default")], [text("Default")]),
        card.default(
        [attribute.aria_labelledby("card_default")],
        [
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("card_basic")], [text("Basic")]),
        card.basic(
        [attribute.aria_labelledby("card_basic")],
        [
          card.header([], [text("Card Header")]),
          card.content([], [text("This is the card content.")]),
          card.footer([], [text("Card Footer")]),
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("card_bordered")], [text("Bordered")]),
        card.bordered(
...
fn button_section() -> Element(Msg) {
  html.section([attribute.class("grid gap-4 p-4 border border-neutral-200 dark:border-neutral-800 rounded bg-neutral-100 dark:bg-neutral-900 dark:text-white")], [
    ...
    [
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_primary")], [text("Primary")]),
        button.basic(
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_secondary")], [text("Secondary")]),
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_success")], [text("Success")]),
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_warn")], [text("Warn")]),
        button.basic_warn(
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_error")], [text("Error")]),
        button.basic_error(
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_basic_info")], [text("Info")]),
        button.basic_info(
      ...
      html.div([attribute.class("grid gap-2")], [
        html.label([attribute.class("font-medium"), attribute.id("button_theme_toggle")], [text("Theme toggle")]),
        button.theme_toggle(
          attr: [
            attribute.aria_labelledby("button_theme_toggle"),
            event.on_click(UserToggledColorScheme), 
