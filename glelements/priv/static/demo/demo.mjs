...
var OnSurface = class extends CustomType {
};
...
function border_width_class(value) {
  if (value === "2") {
    return "border-2";
  } else if (value === "4") {
    return "border-4";
...
function border_size(value) {
  let _pipe = border_width_class(value);
  return class$(_pipe);
}
...
function text3(color, weight, theme) {
  return color_attr(new Text2(), color, weight, theme);
}
function border(color, weight, theme) {
  return color_attr(new Border(), color, weight, theme);
}
...
function basic(attributes, children) {
  ...
  let _pipe$2 = append(_pipe$1, basic_attributes);
  _block = append(_pipe$2, attributes);
  let attr = _block;
  return of(button, attr, children);
}
function basic_secondary(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Secondary(),
      new W400(),
      new Some(new Preferred())
  ...
  return basic(attributes$1, children);
}
function basic_success(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Success(),
      new W400(),
...
function basic_warn(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Warn(),
      new W400(),
...
function basic_error(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Err(),
      new W500(),
...
function basic_info(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Info(),
      new W400(),
...
// build/dev/javascript/glelements/glelements/card.mjs
function of2(element4, attributes, children) {
  return element4(attributes, children);
}
function default$(attributes, children) {
  return of2(article, attributes, children);
}
function header2(attributes, children) {
  return header(prepend(class$(""), attributes), children);
}
function content(attributes, children) {
  return main(prepend(class$(""), attributes), children);
}
function footer2(attributes, children) {
  return footer(prepend(class$(""), attributes), children);
}
function rounded2() {
  return class$("rounded-md");
}
...
function shadow() {
  return class$("shadow-lg");
}
function basic2(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Surface(),
      new W200(),
    ...
    prepend(
      ...
      prepend(
        padding2("md"),
        prepend(rounded2(), prepend(shadow(), attributes))
      )
    )
  );
  return of2(article, attributes$1, children);
}
function bordered(attributes, children) {
  let attributes$1 = prepend(
    background(
      new Surface(),
      new W200(),
...
// build/dev/javascript/glelements/demo/demo.mjs
var FILEPATH = "src/demo/demo.gleam";
...
function card_section() {
  return section(
    ...
    toList([
      h2(toList([class$("text-xl")]), toList([text2("Cards")])),
      div(
        ...
        toList([
          div(
            ...
            toList([
              label(
                ...
                toList([text2("Default")])
              ),
              default$(
                toList([aria_labelledby("card_default")]),
                toList([
                  header2(toList([]), toList([text2("Card Header")])),
                  content(
                    toList([]),
                    toList([text2("This is the card content.")])
                  ),
                  footer2(toList([]), toList([text2("Card Footer")]))
                ])
              )
            ])
          ),
          div(
            ...
            toList([
              ...
              basic2(
                toList([aria_labelledby("card_basic")]),
                toList([
                  header2(toList([]), toList([text2("Card Header")])),
                  content(
                    toList([]),
          ...
          div(
            ...
            toList([
              label(
                ...
                toList([text2("Bordered")])
              ),
              bordered(
                toList([
                  class$(""),
                  aria_labelledby("card_bordered")
                ]),
                toList([
                  header2(toList([]), toList([text2("Card Header")])),
                  content(
          ...
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_primary")
                ]),
                toList([text2("Primary")])
              ),
              basic(
                toList([aria_labelledby("button_basic_primary")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_secondary")
                ]),
                toList([text2("Secondary")])
              ),
              basic_secondary(
                toList([aria_labelledby("button_basic_secondary")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_success")
                ]),
                toList([text2("Success")])
              ),
              basic_success(
                toList([aria_labelledby("button_basic_success")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_warn")
                ]),
                toList([text2("Warn")])
              ),
              basic_warn(
                toList([aria_labelledby("button_basic_warn")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_error")
                ]),
                toList([text2("Error")])
              ),
              basic_error(
                toList([aria_labelledby("button_basic_error")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                toList([
                  class$("font-medium"),
                  id("button_basic_info")
                ]),
                toList([text2("Info")])
              ),
              basic_info(
                toList([aria_labelledby("button_basic_info")]),
                toList([text2("Click here")])
              )
            ])
          ),
          div(
            ...
            toList([
              label(
                ...
                toList([text2("Theme toggle")])
              ),
              theme_toggle(
                toList([
                  aria_labelledby("button_theme_toggle"),
                  on_click(new UserToggledColorScheme())
                ]),
                toList([])
              )
            ])
...
function view(_) {
  return div(
    toList([class$("grid gap-4 px-4 py-8 max-w-6xl mx-auto")]),
    toList([
      div(
        toList([class$("flex justify-between gap-2")]),
        toList([
          h1(
            toList([class$("text-2xl bold mb-8")]),
            toList([text2("Glelements")])
          ),
          theme_toggle(
            toList([
              aria_labelledby("button_theme_toggle"),
              class$("bg-info-400 dark:bg-info-600 text-white h-min"),
              on_click(new UserToggledColorScheme())
            ]),
            toList([])
          )
...
function main2() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError(
      ...
      { value: $, start: 368, end: 418, pattern_start: 379, pattern_end: 384 }
    );
  }
  return $;
}
